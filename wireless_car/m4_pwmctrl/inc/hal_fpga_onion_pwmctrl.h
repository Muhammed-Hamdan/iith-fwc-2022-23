...
#define FPGA_ONION_PWMCTRL_REG_OFFSET_PWM_3_CONFIG      0x000C
...
#define FPGA_ONION_PWMCTRL_REG_ADDR_PWM_3_CONFIG     (uint32_t*)(FPGA_ONION_PERIPH_BASE_ADDR + \
                                                        FPGA_ONION_PWMCTRL_MODULE_OFFSET + \
                                                        FPGA_ONION_PWMCTRL_REG_OFFSET_PWM_3_CONFIG)
